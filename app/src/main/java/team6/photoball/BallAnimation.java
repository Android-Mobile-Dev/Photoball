...
public class BallAnimation extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout container = (LinearLayout) findViewById(R.id.linearLayoutGallery);
    ...
    public class MyAnimationView extends View {
        ...
        public void start() {
            ...
            ShapeHolder newBall = addBall(0, 0);
