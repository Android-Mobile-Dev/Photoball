...
import team6.photoball.Home;
import team6.photoball.MainActivity;
import team6.photoball.R;

import static team6.photoball.widgets.AnimationFactory.AnimationEndListener;
import static team6.photoball.widgets.AnimationFactory.AnimationStartListener;
...
public class ShowcaseView extends RelativeLayout
    ...
    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, boolean newStyle) {
        ...
        float px = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 126, getResources().getDisplayMetrics());
        if (viewCounter == 0) mEndButton.setBackgroundColor(getResources().getColor(R.color.green_button));
        if (viewCounter == 1) mEndButton.setBackgroundColor(getResources().getColor(R.color.black_button));
    ...
    public static int numberOfChilds = 3;
    ...
    private OnClickListener hideOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (viewCounter == 1) {
                ...
                v1.setTarget(settingsTarget);
                v1.setStyle(R.style.CustomShowcaseTheme1);
                v1.build();
            }
            ...
            if (viewCounter == 2) {
                ...
                v1.setTarget(addButtonTarget);
                v1.setStyle(R.style.CustomShowcaseTheme2);
                v1.build();
            }
            ...
            if (viewCounter == 3) {
                ...
                v1.setTarget(addButtonTarget);
                v1.setStyle(R.style.CustomShowcaseTheme3);
                v1.build();
            }
            ...
            if (viewCounter == 4) {
                ...
                v1.setTarget(addButtonTarget);
                v1.setStyle(R.style.CustomShowcaseTheme4);
                v1.build();
            }
        }
    };
